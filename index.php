    ...
    <div class="contenedor seccion seccion-inferior">
            ...
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        ...
                        <source srcset="build/img/blog1.jpg" type="image/gpeg">
                ...
                <div class="texto-entrada">
                    <a href="entrada.html">
                        ...
                        <p>
                            ...
                            mejores materiales y ahorro de dinero.
                        </p>
                    </a>
                </div>
            </article><!--Entrada 1-->
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        ...
                        <source srcset="build/img/blog2.jpg" type="image/gpeg">
        ...
        <section class="testimoniales">
            ...
            <div class="testimonial">
                <blockquote>
                    El personal se porto de una excelente forma, muy buena atencion y la casa que me 
                    ofrecieron con todas las expectativas.
                </blockquote>
                <p>- Alan Mauricio Reyes -</p>
            </div>
        </section>
    </div>
