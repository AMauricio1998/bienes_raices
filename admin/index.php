...
?>
    ...
    <main class="contenedor seccion">
        ...
        <a href="/admin/vendedores/crear.php" class="boton btn-amarillo">Nuevo Vendedor</a>
                    ...
                    <tr><!-- Mostrar los resultados -->
                        ...
                        <td>
                            <form method="post" class="w-100">
                                ...
                                <input class="btn-rojo-block" value="Eliminar" type="submit">
                            </form>
                ...
                <?php foreach($vendedores as $vendedor): ?>
                    <tr><!-- Mostrar los resultados -->
                        ...
                        <td>
                            ...
                            <a href="/admin/vendedores/actualizar.php?id=<?php echo $vendedor->id ?>" class="btn-amarillo-block">Actualizar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
